...
* *Nächster Sprint*
** Angular Custom Elements statt Iframes
...
** Amerikanisches Datumsformat ändern auf europäisches
** Datnbanken übernehmen -> Architektur aneignen
** Über Boxen informieren -> Welche, wie viele?
** Dashboard in plain HTML einbinden und durch URL auf VM erreichbar machen
